...
public interface CommonConstant {
     ...
     * 缺省日志文件名
     * */
    public static final String DEFAULT_LOGGER_NAME = "DEFAULT-LOGGER";

    /**
     * 通信日志文件名
     * */
    public static final String COMMUNICATION_LOGGER_NAME = "COMMUNICATION-LOGGER";

    /**
     * 业务日志文件名
     * */
    public static final String BUSINESS_LOGGER_NAME = "BUSINESS-LOGGER";
     ...
     * 访问权限认证未通过 510
     */
    public static final Integer SC_ANTS_NO_AUTHZ = 510;

    /**
     * 登录用户Shiro权限缓存KEY前缀
     */
    public static String PREFIX_USER_SHIRO_CACHE = "shiro:cache:org.ants.modules.shiro.authc.ShiroRealm.authorizationCache:";
    /**
     * 登录用户Token令牌缓存KEY前缀
     */
     ...
     * code 微信新用户登录
     */
    public static final Integer SC_NEW_USER_1001 = 1001;

    /**
     * 设备离线锁
     */
    public static final String EQUIPMENT_OFFLINE_LOCK_PREFIX = "equipment_offline_lock";
}
