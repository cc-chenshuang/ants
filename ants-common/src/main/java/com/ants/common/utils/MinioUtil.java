...
public class MinioUtil {
     ...
     */
    @SneakyThrows
    public static String upload(MultipartFile file, String uploadType, String customBucket, String fileType) {
        String file_url = "";
...
//            String objectName = bizPath+"/"+orgName.substring(0, orgName.lastIndexOf(".")) + "_" + System.currentTimeMillis() + orgName.substring(orgName.indexOf("."));
     ...
     * @return
     */
    public static String upload(MultipartFile file, String uploadType, String fileType) {
