...
import com.ants.common.utils.TenantContext;
...
/**
 * 单数据源配置（ants.datasource.open = false时生效）
 * @Author chenshuang
 *
 */
@Configuration
@MapperScan(value={"com.ants.modules.**.mapper*"})
public class MybatisPlusConfig {
    ...
    static {
        tenantTable.add("ants_bug_danbiao");
    }
    ...
    public PaginationInterceptor paginationInterceptor() {
        ...
        TenantSqlParser tenantSqlParser = new AntsTenantParser();
